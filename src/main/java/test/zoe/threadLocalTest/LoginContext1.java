...
public class LoginContext1 {
	private static final ThreadLocal<LoginContext1> holder = new ThreadLocal();
	...
	public static LoginContext1 getLoginContext() {
		return (LoginContext1) holder.get();
	}

	public static void setLoginContext(LoginContext1 loginContext) {
	...
	public static ThreadLocal<LoginContext1> getHolder() {
		return holder;
	}
